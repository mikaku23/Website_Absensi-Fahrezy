...
<body>
    ...
    <div class="misc-wrapper">
        ...
        <div class="d-flex justify-content-center mt-5">
            ...
            <img
                src="{{ asset('assets/img/illustrations/misc-mask-light.png') }}"
                alt="misc-error"
                class="misc-bg d-none d-lg-inline-block"
                height="172"
                data-app-light-img="{{ asset('assets/img/illustrations/misc-mask-light.png') }}"
                data-app-dark-img="{{ asset('assets/img/illustrations/misc-mask-dark.png') }}" />
            <div class="d-flex flex-column align-items-center">
                <img
                    src="{{ asset('assets/img/illustrations/404.png') }}"
                    alt="misc-error"
                    class="misc-model img-fluid z-1"
                    width="780" />
                <div>
                    <a href="{{ url()->previous() }}" class="btn btn-primary text-center my-6">Kembali ke halaman sebelumnya</a>
                </div>
            </div>
        </div>
    </div>
