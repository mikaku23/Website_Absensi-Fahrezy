                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="javascript:void(0);" onclick="confirm('Are you sure?') ? document.getElementById('delete-form-{{$da->id}}').submit() : ''">
                                        <i class="ri-delete-bin-6-line me-1"></i> Delete
                                    </a>
                                    <form id="delete-form-{{$da->id}}" action="{{ route('absenSiswa.destroy', $da->id) }}" method="POST" style="display: none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </div>
